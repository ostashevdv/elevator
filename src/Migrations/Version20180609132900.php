 ...
 */
final class Version20180609132900 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id INT NOT NULL, elevator_id INT DEFAULT NULL, from_stage INT NOT NULL, to_stage INT NOT NULL, completed_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
